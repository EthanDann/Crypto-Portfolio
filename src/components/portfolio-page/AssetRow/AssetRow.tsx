          ...
          <Row key={name}>
            ...
            <Column>
              <RowHeader>
                ...
                {confirm_delete && (
                  <DeleteButton
                    onClick={() => dispatch(confirmDeleteAsset(name))}
                  >
                    Delete
                  </DeleteButton>
                )}
              ...
              <RowHeader>
                ...
                {!editable && (
                  <>
                    <EditIconContainer
                      onClick={() => dispatch(editAsset(name))}
                    >
                      <StyledEditIcon />
                    </EditIconContainer>
                    <Subtitle>
              ...
              <AssetContent>
                <ContentRow>
                  ...
                  <AssetInfo>
                    {(getSymbolFromCurrency(coin.symbol) ?? currencySymbol) +
                      coin_amount}
                  </AssetInfo>
                  ...
                  <AssetInfo
                    color={
                      (current_price / historic_price) * 100 >= 0
                        ? "#00FC2A"
                        : "#fe1040"
                    }
                  >
                    ...
                    {((current_price / historic_price) * 100).toFixed(2) + "%"}
                  </AssetInfo>
